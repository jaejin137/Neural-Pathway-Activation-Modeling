...
% Folder setup
fem_dir = ['C:\Users\' user '\Box\DBS_Patient_Modeling\Globus_Pallidus\' full_ID '\Data Processing\COMSOL Output' ];
geom_dir = ['C:\Users\' user '\Box\DBS_Patient_Modeling\Globus_Pallidus\' full_ID '\Data Processing\Axons\Cleaned\'];
...
sim_dir = ['C:\Users\' user '\Box\DBS_Patient_Modeling\Globus_Pallidus\' full_ID '\Data Processing\Axons\Interp\']; 
mkdir(sim_dir)


for j = 1:length(geom_name) 
% load axon geometries
load([geom_dir '\' fem_name '_' side '_' geom_name{j} '.mat'],'axonpop')
...
results_dir = [sim_dir '/' fem_name '_' side '_' geom_name{j} ];
mkdir(results_dir)
for iAxon=1:nAxon
