function [fiber_pts,final_connection_pts1] = axon_4_connect_curved_STNMC(final_pts,nAxon,nSeedPoints)
...
nuc1ptsleft = 1:nSeedPoints; %countdown for contour STN
nuc2ptsleft = 1:nSeedPoints; %countdown for contour STN-MC Path
nuc3ptsleft = 1:nSeedPoints; %countdown for contour MC

%% Step 0: Choose random points for your axons to begin in STN--------------------------------------------------------------------- 
...
for w=1:nAxon
        ...
        %another STN point to connect to randomly that is within 10%
        %closest to it
        ...
        % connect STN to nearest STN-MC Path
...
FC1_1=final_connection_pts1(1:3,:,1);
FC1_2=final_connection_pts1(1:3,:,2);
FC1_3=final_connection_pts1(1:3,:,3);
FC1_4=final_connection_pts1(1:3,:,4);

FC1_1=FC1_1(:,any(FC1_1));
FC1_2=FC1_2(:,any(FC1_2));
FC1_3=FC1_3(:,any(FC1_3));
FC1_4=FC1_4(:,any(FC1_4)); 

clear final_connection_pts1;

final_connection_pts1(:,:,1)=FC1_1;
final_connection_pts1(:,:,2)=FC1_2;
final_connection_pts1(:,:,3)=FC1_3;
final_connection_pts1(:,:,4)=FC1_4;
